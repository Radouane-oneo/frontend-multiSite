    ...
    <?php if (isset($pager_item['pager_text'])) :?>
     <div class="<?php print $settings['pager'] ?>-item <?php print $settings['pager'] ?>-item-<?php print $item_counter ?>">
      <div class="<?php print $settings['pager'] ?>-item-inner"> 
       <a href="#" title="<?php print $pager_item['pager_text']; ?> - <?php print $pager_item['pager_image']; ?>" class="pager-link"><span class="slideshow-title"><?php print $pager_item['pager_text']; ?></span><br /><span class="slideshow-subtitle"><?php print $pager_item['pager_image']; ?></span></a>
      </div>
