	...
	var tmp, loading, overlay, wrap, outer, content, close, title, nav_left, nav_right,
		...
		_finish = function () {
			...
			if (currentOpts.type == 'iframe') {
			    $('<iframe id="fancybox-frame" name="fancybox-frame' + new Date().getTime() + '" frameborder="0" hspace="0" ' + ($.browser.msie ? 'allowtransparency="true""' : '') + ' scrolling="' + selectedOpts.scrolling + '" src="' + currentOpts.href + '" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>').appendTo(content);
			}
